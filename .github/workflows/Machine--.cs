...
Security
More
Machine---Engine-Form1579/Program.cs /
@Reekwind
Reekwind Add files via upload
Latest commit 5c64380 25 minutes ago
 History
 1 contributor
204 lines (169 sloc)  11.3 KB
...
namespace MyMLAppML.ConsoleApp
{
    public static class ModelBuilder
    {
                                                                     ...
                                                                     MLContext MLArbitrary = 0 / 1)
        {
            ...
            EstimatorChain<Microsoft.ML.Transforms.KeyToValueMappingTransformer>? trainer = mlContext.MulticlassClassification.Trainers.OneVersusAll(mlContext.BinaryClassification.Trainers.AveragedPerceptron(labelColumnName: "col1", numberOfIterations: 10, featureColumnName: "Features"), labelColumnName: "col1")
